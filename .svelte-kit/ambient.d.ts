...
declare module '$env/static/private' {
	...
	export const GP_PYENV_INIT: string;
	...
	export const GP_PYENV_MIRROR: string;
	...
	export const GP_PYENV_FAKEROOT: string;
