 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function XS(n){YS(n,(e,t)=>new Yp(e,t,new WS)),n.registerVersion(jS,GS)}XS(mt);const JS={apiKey:"AIzaSyCqXJHKw-oD2ONSQC9pwaM34Qchbxz3aBE",authDomain:"screen-text-4d525.firebaseapp.com",projectId:"screen-text-4d525",storageBucket:"screen-text-4d525.appspot.com",messagingSenderId:"837973930161",appId:"1:837973930161:web:ccd9a4c091553d187fb290",measurementId:"G-6RK05JHM57"};mt.initializeApp(JS);const uk=mt.auth(),lk=new mt.auth.GoogleAuthProvider,ZS=mt.firestore();function ek(n){let e,t,r,i,s;return{c(){e=Qi("main"),t=Qi("div"),r=Qi("div"),i=Qi("h1"),s=sg(n[0]),this.h()},l(o){e=Yi(o,"MAIN",{});var a=Xi(e);t=Yi(a,"DIV",{class:!0});var c=Xi(t);r=Yi(c,"DIV",{class:!0});var u=Xi(r);i=Yi(u,"H1",{class:!0});var l=Xi(i);s=og(l,n[0]),l.forEach(Sr),u.forEach(Sr),c.forEach(Sr),a.forEach(Sr),this.h()},h(){Bo(i,"class","px-5 text-zinc-100 text-center text-6xl whitespace-pre-wrap"),Bo(r,"class","absolute bottom-2/4 w-full"),Bo(t,"class","absolute text-center content-center h-screen w-screen")},m(o,a){ag(o,e,a),Ji(e,t),Ji(t,r),Ji(r,i),Ji(i,s)},p(o,[a]){a&1&&cg(s,o[0])},i:Ru,o:Ru,d(o){o&&Sr(e)}}}function tk(n,e,t){ZS.collection("screen").doc("text").onSnapshot(s=>{t(0,i=s.data().message)});let{message:i=""}=e;return n.$$set=s=>{"message"in s&&t(0,i=s.message)},[i]}class hk extends ng{constructor(e){super(),rg(this,e,tk,ek,ig,{message:0})}}export{hk as S,ik as _,ok as a,sk as b,rk as c,uk as d,lk as e,ZS as f,ck as g,ak as o};
